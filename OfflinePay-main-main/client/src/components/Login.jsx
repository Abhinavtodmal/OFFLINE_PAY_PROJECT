          ...
          >
            <div className="p-1 rounded-lg bg-gradient-to-r from-green-400 via-blue-500 to-purple-500 animate-gradient-border">
              <div className="p-8 space-y-6 bg-white bg-opacity-90 backdrop-blur-md rounded-lg">
                <h1 className="text-3xl font-bold text-center text-gray-800 animate-bounce">
                  Welcome Back!
                </h1>
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                  <div>
                    <label
                      htmlFor="userName"
                      className="block mb-2 text-left text-gray-800 text-sm font-medium"
                    >
                      Username
                    </label>
                    <input
                  ...
                  <div className="relative">
                    ...
                    />
                    {/* Simplified and Smaller Eye Button */}
                    <button
                      type="button"
                  ...
                  <p className="text-center text-black-600">
                    ...
                    <Link
                      to="/signup"
                      className="font-semibold text-indigo-500 hover:text-indigo-600 underline transition-all duration-300 hover:scale-105"
                    >
                      Sign up
                    </Link>
                  </p>
